...
const urlUnescape = () => {
  const encodedInput = document.getElementById(
    "encoded-input"
  ) as HTMLInputElement;
  const decodedResult = document.getElementById(
    "decoded-result"
  ) as HTMLLabelElement;
...
const urlEscape = () => {
  const decodedInput = document.getElementById(
    "decoded-input"
  ) as HTMLInputElement;
  const encodedResult = document.getElementById(
    "encoded-result"
  ) as HTMLLabelElement;
    ...
    <div class="container mx-auto p-4 max-w-2xl min-w-[360px]">
      ...
      <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
        <div class="flex flex-col space-y-3">
          ...
          />
          <label
            class="text-gray-600 text-sm flex items-center px-3"
            id="encoded-result"
          >
          </label>
        </div>
